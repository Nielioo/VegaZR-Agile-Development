                ...
                <a href="{{ route('booking.index', $event->id) }}">
                    <div class="group relative bg-white rounded-2xl shadow flex flex-col overflow-hidden">
                        <div class="aspect-w-3 aspect-h-4 group-hover:opacity-75 sm:aspect-none sm:h-96">
                            <img src="{{ url('/storage/' . $event->poster) }}" alt="Poster"
                                class="w-full h-full object-center object-cover sm:w-full sm:h-full">
                        </div>
                        <div class="flex-1 p-4 space-y-2 flex flex-col">
                            <p
                                class="truncate w-full text-2xl leading-8 font-semibold text-gray-900 group-hover:text-orange-500">
                                {{ $event->name }}
                            </p>
                            <div>
                                ...
                                <div class="flex gap-2 items-center">
                                    ...
                                    <p class="truncate w-full text-lg leading-8 text-gray-700">
                                        {{ $event->location_address }}</p>
                                </div>
                                <div class="mt-2">
                                    <button type="button"
                                        class="w-full inline-flex justify-center items-center space-x-2 rounded focus:outline-none px-3 py-2 leading-6 bg-orange-500 hover:bg-orange-600 focus:ring focus:ring-orange-500 focus:ring-opacity-50 active:bg-orange-500 active:border-orange-500">
